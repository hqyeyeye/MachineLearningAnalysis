...
#No resample, so we use the X_train, Y_train data
...
#fit the data by using the whole training data
xgb_class.fit(X_oversam,Y_oversam,eval_set=[(X_train,Y_train),(X_test,Y_test)],eval_metric=['auc'])
